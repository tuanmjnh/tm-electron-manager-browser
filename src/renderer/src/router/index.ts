 ...
 */
const createHistory = import.meta.env.VITE_APP_SERVER ? createMemoryHistory : import.meta.env.VITE_APP_ROUTER_MODE == 'history' ? createWebHistory : createWebHashHistory
const reCreateRouter = () => createRouter({
  ...
  history: createHistory(import.meta.env.VITE_APP_MODE === 'ssr' ? void 0 : import.meta.env.VITE_APP_ROUTER_BASE)
})
...
const Router = reCreateRouter()//route(reCreateRouter())
